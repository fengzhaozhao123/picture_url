...
def split_data(file_path, new_file_path, train_rate, val_rate):
    ...
    val_images = eachclass_image[int(train_rate * total):]
...
if __name__ == '__main__':
    ...
    # xmlpath= 'txt文件夹'
    # new_file_path='保存的新地址'
    file_path = "./datasets/dolphin_version1/dolphin"
    xmlpath = "./datasets/dolphin_version1/labels"
    new_file_path = "./datasets/dolphin_version1"
    # split_data(file_path, new_file_path, train_rate=0.8, val_rate=0.2, test_rate=0.0)
    split_data(file_path, new_file_path, train_rate=0.8, val_rate=0.2)
